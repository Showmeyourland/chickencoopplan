...
export const articles: Article[] = [
  {
    id: 'chicken-coop-plans',
    slug: 'chicken-coop-plans',
    title: 'Chicken Coop Plans: 20 Free DIY Designs for Every Backyard (2026)',
    excerpt: 'Free chicken coop plans organized by flock size, style, budget, and climate. Every plan includes materials lists, cut diagrams, and step-by-step instructions.',
    ...
    readingTime: 35,
    category: 'Planning',
    tags: ['Chicken Coop Plans', 'Free Plans', 'DIY', 'Backyard', 'Flock Size'],
    difficulty: 'Beginner',
    costRange: '$100-$2,000+',
    featured: true,
    image: '/src/assets/guide-chicken-coop-plans-pillar.jpg',
    seo: {
      metaTitle: 'Chicken Coop Plans: 20 Free DIY Designs for Every Backyard (2026)',
      metaDescription: 'Free chicken coop plans organized by flock size, style, budget, and climate. Every plan includes materials lists and step-by-step instructions.',
    },
  },
  {
    id: 'chicken-coop-plans-4-chickens',
    slug: 'chicken-coop-plans-4-chickens',
    title: 'Chicken Coop Plans for 4 Chickens: 5 Beginner-Friendly Designs (2026)',
    excerpt: 'Five proven chicken coop plans sized for 4 hens. Includes the Classic 4x4, A-Frame, Tractor, Urban Corner, and Converted Shed with costs and materials.',
    author: 'Sarah Martinez',
    authorCredentials: 'Backyard Chicken Expert | Small Flock Specialist',
    date: '2026-04-08',
    updatedDate: '2026-04-08',
    readingTime: 25,
    category: 'Planning',
    tags: ['Chicken Coop Plans', '4 Chickens', 'Beginner', 'Small Flock', 'DIY'],
    difficulty: 'Beginner',
    costRange: '$150-$700',
    featured: true,
    image: '/src/assets/guide-coop-plans-4-chickens.jpg',
    seo: {
      metaTitle: 'Chicken Coop Plans for 4 Chickens: 5 Beginner-Friendly Designs (2026)',
      metaDescription: 'Five proven chicken coop plans sized for 4 hens. Includes costs, materials, and space requirements for each design.',
    },
  },
  {
    id: 'a-frame-chicken-coop-plans',
    slug: 'a-frame-chicken-coop-plans',
    title: 'A-Frame Chicken Coop Plans: Simple Weekend Build Designs (2026)',
    excerpt: 'Three free A-frame chicken coop plans from $100-400. The simplest coop you can build — fewest cuts, lowest cost, and a weekend build for 3-5 hens.',
    author: 'Sarah Martinez',
    authorCredentials: 'Backyard Chicken Expert | DIY Build Specialist',
    date: '2026-04-08',
    updatedDate: '2026-04-08',
    readingTime: 22,
    category: 'Building',
    tags: ['A-Frame', 'Chicken Coop Plans', 'Weekend Build', 'Budget', 'Beginner'],
    difficulty: 'Beginner',
    costRange: '$100-$400',
    featured: true,
    image: '/src/assets/guide-a-frame-coop.jpg',
    seo: {
      metaTitle: 'A-Frame Chicken Coop Plans: Simple Weekend Build Designs (2026)',
      metaDescription: 'Three free A-frame chicken coop plans from $100-400. Fewest cuts, lowest cost, and a weekend build for 3-5 hens.',
    },
  },
  {
    id: 'walk-in-chicken-coop-plans',
    slug: 'walk-in-chicken-coop-plans',
    title: 'Walk-In Chicken Coop Plans: Full-Size Designs for 10+ Hens (2026)',
    excerpt: 'Five walk-in chicken coop plans from 6x8 to 10x16. Stand-up access, easy cleaning, and room for 10-24 hens. DIY costs from $850 to $2,700.',
    author: 'Sarah Martinez',
    authorCredentials: 'Backyard Chicken Expert | Large Coop Specialist',
    date: '2026-04-08',
    updatedDate: '2026-04-08',
    readingTime: 30,
    category: 'Building',
    tags: ['Walk-In Coop', 'Chicken Coop Plans', 'Large Flock', '10+ Hens', 'DIY'],
    difficulty: 'Intermediate',
    costRange: '$850-$2,700',
    featured: true,
    image: '/src/assets/guide-walk-in-coop.jpg',
    seo: {
      metaTitle: 'Walk-In Chicken Coop Plans: Full-Size Designs for 10+ Hens (2026)',
      metaDescription: 'Five walk-in chicken coop plans from 6x8 to 10x16. Stand-up access and room for 10-24 hens. DIY costs from $850 to $2,700.',
    },
  },
  {
    id: 'chicken-coop-plans-materials-list',
    slug: 'chicken-coop-plans-materials-list',
    title: 'Chicken Coop Plans with Materials List: Free Downloadable Guide (2026)',
    excerpt: 'Complete chicken coop materials lists with 2026 prices for 4x4, 4x8, and 8x8 coops. Exact quantities, specs, and where to buy every item.',
    author: 'Sarah Martinez',
    authorCredentials: 'Backyard Chicken Expert | Materials Specialist',
    date: '2026-04-08',
    updatedDate: '2026-04-08',
    readingTime: 20,
    category: 'Building',
    tags: ['Materials List', 'Chicken Coop Plans', 'Shopping List', 'Lumber', 'Hardware'],
    difficulty: 'Beginner',
    costRange: '$185-$950',
    featured: true,
    image: '/src/assets/guide-coop-materials-list.jpg',
    seo: {
      metaTitle: 'Chicken Coop Plans with Materials List: Free Downloadable Guide (2026)',
      metaDescription: 'Complete chicken coop materials lists with 2026 prices for 4x4, 4x8, and 8x8 coops. Exact quantities and where to buy.',
    },
  },
  {
