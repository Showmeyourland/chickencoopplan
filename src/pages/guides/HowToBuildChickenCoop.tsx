    ...
    <BlogLayout article={article}>
      ...
      <section id="planning" className="mb-12">
        ...
        <p className="text-muted-foreground mb-6">
          Before you buy a single board, you need to nail down three critical decisions. I learned this the hard way when my neighbor called code enforcement on my first coop because I'd placed it 15 feet from the property line instead of the required 20 feet.
        </p>
